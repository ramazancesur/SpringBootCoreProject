...
public class JasperReport {
    ...
    public String createReport(final EnumUtil.JasperReportType reportType, String reportName, List lstCollection, HashMap<String, String> mapColumnNames,
                               HashMap<String, Class> map, PageType pageType, PageOrientation pageOrientation) {

        ColumnBuilder[] columnBuilder = createColumnBuilder(map, mapColumnNames);
        JRDataSource dataSource = new
                JRBeanCollectionDataSource(lstCollection);
        final JasperReportBuilder jasperReportBuilder = createJasperBuilder(dataSource, columnBuilder, pageType, pageOrientation, reportName, reportType);
    ...
    public String convertBase64OutputStream(ByteArrayOutputStream outputStream){
        ...
        // Aşagıda java 8 de bulunmayan switch casede string işlemleri için 1.7 ye göre yazılmıştır 
        return org.apache.commons.codec.binary.Base64.encodeBase64String(exporterDataByte);
    }

    public String createReportIReportwithSubReport(String masterReportFileName, String subReportFileName, List lstGenericData,
                                                     EnumUtil.JasperReportType reportType, String reportName, String parametreName, String subDir) throws JRException {
        ...
        try {
            jasperMasterReport = JasperCompileManager
                    .compileReport(masterReportFileName);
            jasperSubReport = JasperCompileManager
        ...
        JRBeanCollectionDataSource beanColDataSource = new
                JRBeanCollectionDataSource(lstGenericData);
    ...
    public String createReportIReportswithSubReportList(String masterReportFileName, String masterReportFileName1, String masterReportFileName2, Map<String, String> mapSubReportFileName, List lstGenericData, List lstTeblig,
                                                          EnumUtil.JasperReportType reportType, String reportName,
                                                          Map<String, String> mapParametreName, String subReportDir) throws JRException {
        net.sf.jasperreports.engine.JasperReport jasperMasterReport = null;
        ...
        try {
            ...
            jasperMasterReport1 = JasperCompileManager
                    .compileReport(masterReportFileName1);

            jasperMasterReport2 = JasperCompileManager
                    .compileReport(masterReportFileName2);

            for (Map.Entry<String, String> subReportFileName : mapSubReportFileName.entrySet()) {
                lstSubJasper.add(JasperCompileManager
                        .compileReport(subReportFileName.getValue()));
        ...
        JRBeanCollectionDataSource beanColDataSource = new
                JRBeanCollectionDataSource(lstGenericData);
        JRBeanCollectionDataSource beanColDataSource1 = new
                JRBeanCollectionDataSource(lstGenericData);
        JRBeanCollectionDataSource beanColDataSource2 = new
                JRBeanCollectionDataSource(lstTeblig);

        final JasperPrint finalJasperPrint = JasperFillManager.fillReport(jasperMasterReport,
                parameters, beanColDataSource);
        final JasperPrint finalJasperPrint1 = JasperFillManager.fillReport(jasperMasterReport1,
                parameters1, beanColDataSource1);
    ...
    public String createReportIReportwithSubReportList(String masterReportFileName, Map<String, String> mapSubReportFileName, List lstGenericData,
                                                         EnumUtil.JasperReportType reportType, String reportName,
                                                         Map<String, String> mapParametreName, String subReportDir) throws JRException {
    ...
    public String createReportWithDataSource(final EnumUtil.JasperReportType reportType, String reportName, JRDataSource dataSource, HashMap<String, String> mapColumnNames,
                                               HashMap<String, Class> map, PageType pageType, PageOrientation pageOrientation) {
    ...
    private JasperReportBuilder createJasperBuilder(JRDataSource dataSource, ColumnBuilder[] columnBuilders, PageType pageType, PageOrientation pageOrientation, String reportName
